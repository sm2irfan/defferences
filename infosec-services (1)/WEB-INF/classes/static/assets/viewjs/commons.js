...
createDefaultEngagementForms = function (engagementId) {
    ...
    $.ajax("/infosec-api/engagements/" + engagementId + "/default-engagement-forms", {
        ...
        async: false,
        contentType: 'application/json',
        data: '["SUMMARY","SOLUTION_REVIEW","DATA_PRIVACY","EA_REPO_MEGA","OWG","PLATFORM_SECURITY","CLOUD_THIRD_PARTY_HOSTING","CUSTOMER_FACING_APPLICATION","SECURITY_TOOLS","NETWORK_MANAGED_SYSTEMS","INTERFACE_CONTRACTS","SOLUTION_ARCHITECTURE","SECURITY_TESTING","RISK_PRE_APPROVAL_FORM"]',
        success: function (engagementId, textStatus, jQxhr) {
            console.log("Form Successfully Created");
            val = "Engagement Form Successfully Created";
        },
